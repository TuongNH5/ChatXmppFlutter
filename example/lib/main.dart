...
import 'package:flutter_xmpp_example/DataChat.dart';
...
class _MyAppState1 extends State<MyApp>
  ...
  TextEditingController(text: 'pnc.pdx_fpt.net');
  TextEditingController _passwordController =
  TextEditingController(text: '12345678a@');
  TextEditingController _hostController =
  TextEditingController(text: 'chat.mypt.vn');
  ...
  void _showConnectionStatus() async {
    try {
      ...
      if (_scaffoldKey.currentState != null) {
        ...
        // ));
        print('connectionStatus.toString() ${connectionStatus.toString()}');
      }
    } catch (e) {
      print(e);
    }
...
//   }
//
//    getTextChat(String body){
//     DataChat dataChat = DataChat.fromJson(body);
//     print('dataChat ${dataChat.text}');
//   }
//   createMUC(String groupName, bool persistent) async {
//     bool groupResponse = await flutterXmpp.createMUC(groupName, persistent);
//     print('responseTest groupResponse $groupResponse');
